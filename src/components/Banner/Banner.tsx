      ...
      position: 'relative',
        ...
        <ul sx={{
          ...
          '@media screen and (max-width: 768px)': {
            ...
            <li sx={{cursor: 'pointer',  position: 'relative', 
            '&::after': {
              content: '""',
              position: 'absolute',
              top: '35px',
            ...
            '&:hover': {
              ...
              '&:hover + .categories-modal': {
               ...
               <div sx={{paddingLeft: 5, paddingRight: 5, position: 'absolute', top: '35px', left: 0, zIndex: 2, background: '#fff', opacity: 0, '&:hover': { display: 'flex',opacity: 1}, 
        ...
        <div sx={{
         ...
         <div sx={{
          ...
          <h6 sx={{ width: '100%', margin: 0, paddingBottom: 1,  
          ...
          <ul sx={{
            ...
            <li key={item} sx={{cursor: 'pointer',  '&:hover': {
              color: 'secondary', 
            },}}>{item}</li>
          ))}
          </ul>
